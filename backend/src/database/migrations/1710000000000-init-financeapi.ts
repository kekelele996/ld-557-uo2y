...
export class InitFinanceapi1710000000000 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE portfolios (id SERIAL PRIMARY KEY, user_id INT NOT NULL REFERENCES users(id), name VARCHAR NOT NULL, description TEXT DEFAULT '', type portfolio_type NOT NULL, risk_level risk_level NOT NULL, initial_cash DECIMAL(18,2) DEFAULT 0, cash DECIMAL(18,2) DEFAULT 0, realized_pnl DECIMAL(18,2) DEFAULT 0, total_value DECIMAL(18,2) DEFAULT 0, created_at TIMESTAMP DEFAULT now())`);
